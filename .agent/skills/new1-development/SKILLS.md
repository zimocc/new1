# 📖 背单词 H5 应用 — 项目 Skills 总纲

> **最后更新**: 2026-04-22
> **维护者**: 瑾恒/瑾言's Dad

本文档是项目 AI 辅助开发的"知识库入口"。后续所有对话均可引用此文档及同目录下的子文件，快速获取项目全貌。
...
- **项目名称**: 背单词 (new1)
- **定位**: 面向儿童（小学 & 新概念英语）的移动端优先 H5 单词学习工具
- **线上部署**: Cloudflare Pages（含 Functions Serverless API 代理）
- **核心价值**: 提供"听写模式"、"自动发音"、多教材切换和持久化学习进度等功能
